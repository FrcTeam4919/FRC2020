...
public interface Sendable {
  ...
  default String getName() {
    return SendableRegistry.getName((edu.wpi.first.wpilibj.Sendable) this);
  }
  ...
  default void setName(String name) {
    SendableRegistry.setName((edu.wpi.first.wpilibj.Sendable) this, name);
  }
  ...
  default void setName(String subsystem, String name) {
    SendableRegistry.setName((edu.wpi.first.wpilibj.Sendable) this, subsystem, name);
  }
  ...
  default void setName(String moduleType, int channel) {
    SendableRegistry.setName((edu.wpi.first.wpilibj.Sendable) this, moduleType, channel);
  }
  ...
  default void setName(String moduleType, int moduleNumber, int channel) {
    SendableRegistry.setName((edu.wpi.first.wpilibj.Sendable) this, moduleType, moduleNumber, channel);
  }
  ...
  default String getSubsystem() {
    return SendableRegistry.getSubsystem((edu.wpi.first.wpilibj.Sendable) this);
  }
  ...
  default void setSubsystem(String subsystem) {
    SendableRegistry.setSubsystem((edu.wpi.first.wpilibj.Sendable) this, subsystem);
  }
  ...
  default void addChild(Object child) {
    SendableRegistry.addChild((edu.wpi.first.wpilibj.Sendable) this, child);
  }
