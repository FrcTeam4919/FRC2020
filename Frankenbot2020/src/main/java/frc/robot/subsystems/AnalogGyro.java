...
public class AnalogGyro extends GyroBase implements Gyro, PIDSource, Sendable, AutoCloseable {
  ...
  public void initGyro() {
    ...
    SendableRegistry.addLW((edu.wpi.first.wpilibj.Sendable) this, "AnalogGyro", m_analog.getChannel());
  }
  ...
  public AnalogGyro(int channel) {
    ...
    SendableRegistry.addChild((edu.wpi.first.wpilibj.Sendable) this, m_analog);
  }
  ...
  @Override
  public void close() {
    SendableRegistry.remove((edu.wpi.first.wpilibj.Sendable) this);
