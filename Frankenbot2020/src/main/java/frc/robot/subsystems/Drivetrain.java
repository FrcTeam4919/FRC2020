...
public static VictorSP encoderM;
...
//The heading of the robot when starting the motion
    ...
    public Drivetrain() {
        ...
        encoderM = new VictorSP(3);
        addChild("EncoderM",encoderM);
        encoderM.setInverted(false);
        ...
        encoder = new Encoder(2, 3, true, Encoder.EncodingType.k4X);
        //encoder.setDistancePerPulse(1.0/25.9);
    ...
    public void moveForward() {
        westCoastTankDrive.arcadeDrive(0.5, 0.5);
    }
